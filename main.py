...
process_antispoof = ProcessAntiSpoof(source_coords=source_coords,
                                     mode='data_collection_from_camera',
                                     )
...
while True:
    ...
    st = dt.now()
    return_code, prob = process_antispoof.do_the_work(ds_mode='train',draw_icp=True,ds_type='true')
